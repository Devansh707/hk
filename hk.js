...
function questionSolver(page, questionnumber, answer) {
    return new Promise(function (resolve, reject) {
        ...
        qWillbeclickedPromise
            // Wait and Click on the test input button
        // Reach to monaco editor then goto test input bcz it was unable to reach test input directly
            // then wait and click on the test box
            // type in text box
            // Ctrl+A, Ctrl+x
            // then wait and click in the monaco editor
            // Ctrl+A, Ctrl+V
            .then(function () {
            ...
            .then(function () {
                //Wait and click on the test input
                return waitAndClick(".checkbox-input", page);
            }).then(function () {
                // then wait and click on the test box
                return page.waitForSelector("textarea.custominput", {visible: true});
            }).then(function () {
                return page.keyboard.type( answer, {delay: 7});
            }).then(function () {
            ...
            let waitForEdotortobeFocusedPromise = waitAndClick(".monaco-editor.no-user-select.vs", page);
                ...
                return page.keyboard.press("V", { delay: 500 });
            }).then(function () {
                return page.keyboard.up("Control");
            }).then(function () {
